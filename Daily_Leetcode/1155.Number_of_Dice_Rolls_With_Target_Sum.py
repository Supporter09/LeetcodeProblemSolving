# Ý tưởng cho tìm số cách tính tổng để = target
# Tìm các bộ số sao cho có tổng = target => Số bộ số là hoán vị của các số trong bộ số đó
# Nếu tìm đc x bộ số: kết quả là n!.x
# Duyệt từ 1 -> target // n => Tìm các bộ số
class Solution:
    mod = 10 ** 9 + 7
